...
// Mirrors the frontend contract in `src/types/portal.ts` — keep both in sync
// (AGENTS.md §6). Every portal read is ownership-scoped server-side; the API
// surface has no admin "list everyone" semantics.
