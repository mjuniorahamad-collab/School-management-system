...
export const createStaffSchema = z
  .object({
    ...
    gender: z.enum(STAFF_GENDERS, { message: "Gender is required" }),
...
export type ListStaffsQuery = z.infer<typeof listStaffsQuerySchema>
